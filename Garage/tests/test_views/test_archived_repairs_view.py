...
class TestRepairsArchivedView(TestCase):
    ...
    def test_logged_in_user_receives_archived_repairs(self):
        ...
        response = c.get('/repairs/archived/')
        self.assertEqual(len(response.context['repairs']), 2)
    ...
    def test_logged_in_user_receives_all_repairs_data(self):
        ...
        self.assertEqual(repair[0][0].type_of_repair, first_repair.type_of_repair)
        self.assertEqual(repair[0][0].name, first_repair.name)
        self.assertEqual(repair[0][0].description, first_repair.description)
        self.assertEqual(repair[0][0].note, first_repair.note)
        self.assertEqual(repair[0][0].mileage, first_repair.mileage)
        self.assertEqual(repair[0][0].price, first_repair.price)
        self.assertTrue(repair[0][0].archive)
        self.assertEqual(repair[0][0].car, first_repair.car)

        self.assertEqual(repair[0][1].type_of_repair, second_repair.type_of_repair)
        self.assertEqual(repair[0][1].name, second_repair.name)
        self.assertEqual(repair[0][1].mileage, second_repair.mileage)
        self.assertTrue(repair[0][1].archive)
        self.assertEqual(repair[0][1].car, second_repair.car)

        self.assertEqual(repair[1][0].type_of_repair, third_repair.type_of_repair)
        self.assertEqual(repair[1][0].name, third_repair.name)
        self.assertTrue(repair[1][0].archive)
        self.assertEqual(repair[1][0].car, third_repair.car)
