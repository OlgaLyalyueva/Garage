...
class TestInsurancesArchivedView(TestCase):
    ...
    def test_logged_in_user_receives_archived_insurances(self):
        ...
        response = c.get('/insurances/archived/')
        self.assertEqual(len(response.context['insrnc']), 2)
    ...
    def test_logged_in_user_receives_all_insurances_data(self):
        ...
        self.assertEqual(insurances[0][0].type, first_insrnc.type)
        self.assertEqual(insurances[0][0].description, first_insrnc.description)
        self.assertEqual(insurances[0][0].policy_number, first_insrnc.policy_number)
        self.assertEqual(insurances[0][0].start_date, first_insrnc.start_date)
        self.assertEqual(insurances[0][0].end_date, first_insrnc.end_date)
        self.assertEqual(insurances[0][0].price, first_insrnc.price)
        self.assertTrue(insurances[0][0].archive)
        self.assertEqual(insurances[0][0].car, first_insrnc.car)

        self.assertEqual(insurances[0][1].type, second_insrnc.type)
        self.assertEqual(insurances[0][1].description, second_insrnc.description)
        self.assertEqual(insurances[0][1].policy_number, second_insrnc.policy_number)
        self.assertEqual(insurances[0][1].start_date, second_insrnc.start_date)
        self.assertEqual(insurances[0][1].end_date, second_insrnc.end_date)
        self.assertEqual(insurances[0][1].price, second_insrnc.price)
        self.assertTrue(insurances[0][1].archive)
        self.assertEqual(insurances[0][1].car, second_insrnc.car)

        self.assertEqual(insurances[1][0].type, third_insrnc.type)
        self.assertEqual(insurances[1][0].description, third_insrnc.description)
        self.assertEqual(insurances[1][0].policy_number, third_insrnc.policy_number)
        self.assertEqual(insurances[1][0].start_date, third_insrnc.start_date)
        self.assertEqual(insurances[1][0].end_date, third_insrnc.end_date)
        self.assertEqual(insurances[1][0].price, third_insrnc.price)
        self.assertTrue(insurances[1][0].archive)
        self.assertEqual(insurances[1][0].car, third_insrnc.car)
